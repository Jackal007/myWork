...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin-welcome.jsp">首页</a><span class="crumb-step">&gt;</span><span>修改商家信息</span>
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="SellerServlet?method=editCommit" method="POST">
                	
                    <table class="insert-tab" width="100%">
                 	   <input type="hidden" name="sellerId" value="${ seller.sellerId }"/>
                        <tbody>
                            <tr>
                              <th width="120"><i class="require-red">*</i>商家名称：</th>
                               <td>
                                    <input class="common-text required" placeholder="${ seller.sellerName }" value="${ seller.sellerName }" id="seller" name="seller" size="50" type="text"/>
                               </td>
                            </tr>
                            <tr>
                                <th>是否重置商家密码</th>
                            ...
                            <tr>
                              <th width="120"><i class="require-red">*</i>联系电话：</th>
                               <td>
                                    <input class="common-text required" placeholder="${ seller.sellerTel }" value="${ seller.sellerTel }" id="tele" name="tele" size="50" type="text"/>
                               </td>
                            </tr>
                            <tr>
                                <th>密保问题：</th>
                                <td>
                                    <label>${ seller.sellerSQuestion }</label>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    ...
                                    <input class="btn btn6" value="取消" type="button" onclick="javascript:location.href='SellerServlet?method=showSellers'">
                                </td>
                            </tr>
                        </tbody></table>
                </form>
