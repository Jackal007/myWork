<%@ page language="java" import='com.xmu.darksky.service.*' contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
...
<body>
		...
		<div class="topbar-inner clearfix">
			<div class="topbar-logo-wrap clearfix">
				<h1 class="topbar-logo none">
					<a href="admin-welcome.jsp" class="navbar-brand">后台管理</a>
				</h1>
			</div>
		</div>
	</div>
		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin-welcome.jsp">首页</a><span
						class="crumb-step">&gt;</span><span>增加用户</span>
			...
			<div class="result-wrap">
				<div class="result-content">
					<form action="CusServlet?method=addCustomer" method="POST" onsubmit="return signUp();">
						<table class="insert-tab" width="100%">
							<tbody>
								<tr>
									<th width="120"><i class="require-red">*</i>用户名：</th>
									<td><input class="common-text required"
										placeholder="请输入你的用户名" id="user" name="user" size="50"
										type="text" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input class="common-text required"
										placeholder="请输入你的收货地址" id="addr" name="addr" size="50"
										type="text" /></td>
								</tr>
								<tr>
									<th width="120">密保问题：</th>
									<td><input class="common-text required"
										placeholder="请输入你的密保问题" id="sQuestion" name="sQuestion"
										size="50" type="text" /></td>
								</tr>
								<tr>
									<th width="120">密保答案：</th>
									<td><input class="common-text required"
										placeholder="请输入你的密保答案" id="sAnswer" name="sAnswer" size="50"
										type="text" /></td>
								</tr>
								<tr>
									<th></th>
	...
	<%
		if (request.getAttribute("addCusState") != null
				&& request.getAttribute("addCusState").toString().equals("true")) {
			request.removeAttribute("addCusState");
			out.print("<script>alert('添加成功');</script>");
		} else if (request.getAttribute("addCusState") != null) {
			request.removeAttribute("addCusState");
