	...
	%>
		...
		<div class="wrapper">
			<div class="maincontainer">
				<div class="leftnav">
					<ul>
						<li class="active"><a href="#" id="choose9" name="my_information.jsp">个人中心</a></li>
				   ...
				   href="#collapseOne">审核管理</a></li>
					  ...
					  <li><a data-toggle="collapse" data-parent="#accordion" 
				   href="#collapseTwo">管理员管理</a></li>
				   		<div id="collapseTwo" class="panel-collapse collapse">
						  <li class="second"><a href="#" id="choose3" name="admin_list.jsp">管理员列表</a></li>
						  <li class="second"><a href="#" id="choose4" name="add_admin.jsp">增加管理员</a></li>
					  </div>
					  <li><a data-toggle="collapse" data-parent="#accordion" 
				   href="#collapseThree">单位管理</a></li>
				   		<div id="collapseThree" class="panel-collapse collapse">
						  <li class="second"><a href="#" id="choose7" name="institution_list.jsp">单位列表</a></li>
						  <li class="second"><a href="#" id="choose8" name="add_institution.jsp">增加单位</a></li>
					  </div>
					  <li><a href="#" id="choose5" name="adminpage5.jsp">活动室管理</a></li>
					  <li><a href="#" id="choose6" name="adminpage6.jsp">活动室预约</a></li>
					</ul>
				</div>
